...
void SR_write40(uint8_t command, uint16_t data, uint16_t address){
    ...
    for(uint8_t i = 0; i<16; i++){
        LATAbits.LATA3 = (uint8_t)address;
        {LATAbits.LATA0 = 1; __nop(); LATAbits.LATA0 = 0;};
        address = address >> 1;
    }


    for(uint8_t i = 0; i<16; i++){
        LATAbits.LATA3 = (uint8_t)data;
        {LATAbits.LATA0 = 1; __nop(); LATAbits.LATA0 = 0;};
        data = data >> 1;
    }
    ...
    for(uint8_t i = 0; i<8; i++){
        LATAbits.LATA3 = command;
        {LATAbits.LATA0 = 1; __nop(); LATAbits.LATA0 = 0;};
        command = command >> 1;
    }


    {LATAbits.LATA1 = 1; __nop(); LATAbits.LATA1 = 0;};
}
